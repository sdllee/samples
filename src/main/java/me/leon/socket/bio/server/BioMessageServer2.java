...
public class BioMessageServer2 {

    private static Logger logger = LoggerFactory.getLogger(BioMessageServer2.class);
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            while (true) {
                ...
                Runnable r = new MessageHanlder2(incoming); // 链接成功， 实例化线程接口
