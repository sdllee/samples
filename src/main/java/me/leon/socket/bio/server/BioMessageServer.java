...
public class BioMessageServer {

    private static Logger logger = LoggerFactory.getLogger(BioMessageServer.class);
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            while (true) {
                ...
                Runnable r = new MessageHanlder(incoming); // 链接成功， 实例化线程接口
